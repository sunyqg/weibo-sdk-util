...
Value::operator ==( const Value &other ) const
{
   ...
   case int64Value:
	  return value_.int64_ == other.value_.int64_;
   case uint64Value:
	  return value_.int64_ == other.value_.uint64_;
   case booleanValue:
      return value_.bool_ == other.value_.bool_;
   case stringValue:
...
Value::asInt() const
{
   ...
   /* begin ---------- insert by ÂÀ³¿¹â 2011/7/10 ---------  */
   case int64Value:
	  JSON_ASSERT_MESSAGE( value_.int64_ >= minInt  &&  value_.int64_ <= maxInt, "long long out of signed integer range" );
	  return Int( value_.int64_);
   case uint64Value:
	  JSON_ASSERT_MESSAGE( value_.uint64_ >= minInt  &&  value_.uint64_ <= maxInt, "unsigned long long out of signed integer range" );
...
Value::isConvertibleTo( ValueType other ) const
{
   ...
   case intValue:
      return ( other == nullValue  &&  value_.int_ == 0 )
             ...
             || other == realValue
			 || other == int64Value
			 || (other == uint64Value && value_.int64_ >= 0)
             || other == stringValue
             || other == booleanValue;
   case uintValue:
   ...
   case realValue:
      return ( other == nullValue  &&  value_.real_ == 0.0 )
             ...
             || other == realValue
			 || ( other == int64Value  &&  value_.real_ >= minInt64  &&  value_.real_ <= maxInt64 )
			 || ( other == uint64Value  &&  value_.real_ >= 0  &&  value_.real_ <= maxUInt64 )
             || other == stringValue
             || other == booleanValue;
   case int64Value:
	   return ( other == nullValue  &&  value_.int_ == 0 )
             || ( other == intValue  &&  value_.int64_ >= minInt  &&  value_.int64_ <= maxInt )
			 || ( other == uintValue  &&  value_.uint64_ >= 0  &&  value_.uint64_ <= maxUInt )
			 || other == int64Value
			 || (other == uint64Value  &&  value_.int64_ >= 0)
             || other == realValue
             || other == stringValue
   ...
   case uint64Value:
	   return ( other == nullValue  &&  value_.uint_ == 0 )
             || ( other == intValue  &&  value_.uint64_ >= minInt  &&  value_.uint64_ <= (unsigned)maxInt )
			 || ( other == uintValue  &&  value_.uint64_ >= 0  &&  value_.uint64_ <= maxUInt )
			 || (other == int64Value && value_.uint64_ <= maxInt64)
			 || other == uint64Value
             || other == realValue
             || other == stringValue
             || other == booleanValue;
